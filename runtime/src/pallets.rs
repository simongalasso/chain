...
/// Integritee Teerex
impl integritee_teerex::Config for Runtime {
    type Event = Event;
    type Currency = pallet_balances::Pallet<Runtime>;
    type MomentsPerDay = MomentsPerDay;
    type MaxSilenceTime = MaxSilenceTime;
    type WeightInfo = integritee_teerex::weights::IntegriteeWeight<Runtime>;
}
...
/// Integritee Teeracle
impl integritee_teeracle::Config for Runtime {
    type Event = Event;
    type WeightInfo = integritee_teeracle::weights::IntegriteeWeight<Runtime>;
